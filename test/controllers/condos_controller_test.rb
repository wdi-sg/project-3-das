...
class CondosControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post condos_url, params: { condo: { name: @condo.name, postal_code: @condo.postal_code } }
  #   end
  #
  ...
  #   patch condo_url(@condo), params: { condo: { name: @condo.name, postal_code: @condo.postal_code } }
